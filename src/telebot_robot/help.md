# Guidelines and FAQs for Level 1: ROS2 Navigation telebot

This document is here to provide additional guidance to help you complete the telebot successfully. We’ve also included a Frequently Asked Questions (FAQ) section to address common concerns. If you still have questions, feel free to reach out—details at the end!

---

## Guidelines

- **Start Small**: Approach the telebot step by step. Begin by understanding the simulation environment before diving into the navigation workflows.
...
### Q1: I don’t have Ubuntu 22.04. Can I still complete the telebot?
...
### Q5: Can I modify the robot or telebot environment?
**A**: Yes, feel free to make changes to suit your implementation, but ensure your solution works with the provided map and telebot as well.

---

## Need Help?
If you encounter any bugs in the provided code or have questions about the telebot, please don’t hesitate to contact me at **rohit.panikar@ericrobotics.com**.
